...
import { RetriesCommandableHttpServiceV1 } from '../services/version1';
...
export class RetriesServiceFactory extends Factory {
	...
	public static CmdHttpServiceDescriptor = new Descriptor("service-retries", "service", "commandable-http", "*", "1.0");
	...
	constructor() {
		...
		this.registerAsType(RetriesServiceFactory.CmdHttpServiceDescriptor, RetriesCommandableHttpServiceV1);
